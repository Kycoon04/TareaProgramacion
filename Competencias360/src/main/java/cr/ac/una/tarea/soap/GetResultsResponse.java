 ...
 *       <sequence>
 *         <element name="return" type="{http://controller.tareaws.una.ac.cr/}resultDto" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class GetResultsResponse {
    ...
    protected List<ResultDto> _return;
     ...
     */
    public List<ResultDto> getReturn() {
        if (_return == null) {
