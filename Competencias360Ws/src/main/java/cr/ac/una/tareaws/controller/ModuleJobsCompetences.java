...
public class ModuleJobsCompetences {
     ...
     * @param idJobC El ID de la tabla de competencias de trabajo que se desea obtener.
     * @return Un objeto JobsCompetencesDto que representa la competencia de trabajo.
     * @throws IOException Si ocurre un error al acceder a los datos.
     */ 
     ...
     * @param jobsCompetencesDto Un objeto JobsCompetencesDto que contiene la información de la competencia de trabajo a registrar.
     ...
     * @return Una lista de objetos JobsCompetencesDto que representan las competencias de trabajo.
     * @throws IOException Si ocurre un error al acceder a los datos.
     */
