...
/**
 * Clase que implementa un servicio web para gestionar los evaluadores.
 * Este servicio proporciona operaciones como obtención por ID, obtención por estado, obtención por retroalimentación,
 * registro, eliminación y listado de evaluadores.
...
public class ModuleEvaluators {
     ...
     * @param FeedBack La retroalimentación de los evaluadores que se desean obtener.
     * @return Un objeto EvaluatorsDto que representa a los evaluadores.
     * @throws IOException Si ocurre un error al acceder a los datos.
     */
     ...
     * @param evaluatorsDto Un objeto EvaluatorsDto que contiene al evaluador a registrar.
     ...
     * @return Una lista de objetos EvaluatorsDto que representan a los evaluadores.
     * @throws IOException Si ocurre un error al acceder a los datos.
     */
