...
/**
 * Clase que implementa un servicio web para gestionar competencias. Este
 * servicio proporciona operaciones como registro, obtención, eliminación y
 * listado de competencias. Se utiliza anotaciones JAX-WS para exponer los
 * métodos como operaciones web.
 */
...
public class ModuleCompetences {
     ...
     *
     * @param competencesDto Un objeto CompetencesDto que contiene la
     * competencia a registrar.
     ...
     *
     * @return Una lista de objetos CompetencesDto que representan las
     * competencias.
     * @throws IOException Si ocurre un error al acceder a los datos.
     */
